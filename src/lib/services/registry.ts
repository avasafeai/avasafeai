...
// ── OCI Miscellaneous Services stub ───────────────────────────────────────────

export const OCI_MISC: ServiceConfig = {
  id: 'oci_misc',
  name: 'OCI Miscellaneous Services',
  short_name: 'OCI Misc',
  description: 'Update OCI details after new passport or personal changes',
  category: 'oci',
  available: false,
  coming_soon: true,
  icon: 'RefreshCw',
  ...
  requirements_search_query: 'OCI miscellaneous services USA requirements 2025',
}
