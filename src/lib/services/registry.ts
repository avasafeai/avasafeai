      ...
      fields: [
        {
          ...
          prefill_from: 'email',
          format_hint: null,
          warning: 'Use an email you check regularly — all updates sent here',
          required: true,
        },
        {
          id: 'mobile',
      ...
      fields: [
        {
          ...
          field_type: 'file',
          prefill_from: null,
          format_hint: 'Square JPEG, white background, min 200x200px, max 200kb',
        ...
        },
        {
          ...
          field_type: 'file',
          prefill_from: null,
          format_hint: 'JPEG, aspect ratio 1:3 (wide), max 200kb',
          warning: null,
          required: true,
        },
      ],
...
export const OCI_MISC: ServiceConfig = {
  ...
  required_documents: [
    ...
    },
    {
      ...
      doc_type: 'photo',
      mandatory: true,
      notes: 'Square JPEG, white background, minimum 51x51mm, max 200kb.',
      which_pages: null,
    },
    {
      id: 'address_proof',
  ...
  portal_sections: [
    ...
    },
    {
      ...
      estimated_minutes: 2,
      fields: [
        { id: 'photo_upload', label: 'Passport photo', portal_label: 'Upload Photo', field_type: 'file', prefill_from: null, format_hint: 'Square JPEG, white background, min 200x200px, max 200kb', warning: null, required: true },
        { id: 'signature_upload', label: 'Signature', portal_label: 'Upload Signature', field_type: 'file', prefill_from: null, format_hint: 'JPEG, aspect ratio 1:3, max 200kb', warning: null, required: true },
      ],
    },
  ],
